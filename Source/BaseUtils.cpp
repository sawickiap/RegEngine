...
#define FORMAT_PAIR(first, last, result) if(format >= first && format <= last) return result;
    ...
    FORMAT_PAIR(DXGI_FORMAT_R32G32B32A32_TYPELESS, DXGI_FORMAT_R32G32B32A32_SINT, 4 * 4 * BITS_PER_BYTE);
    FORMAT_PAIR(DXGI_FORMAT_R32G32B32_TYPELESS, DXGI_FORMAT_R32G32B32_SINT, 3 * 4 * BITS_PER_BYTE);
    FORMAT_PAIR(DXGI_FORMAT_R16G16B16A16_TYPELESS, DXGI_FORMAT_R16G16B16A16_SINT, 4 * 2 * BITS_PER_BYTE);
    FORMAT_PAIR(DXGI_FORMAT_R32G32_TYPELESS, DXGI_FORMAT_X32_TYPELESS_G8X24_UINT, 2 * 4 * BITS_PER_BYTE);
    FORMAT_PAIR(DXGI_FORMAT_R10G10B10A2_TYPELESS, DXGI_FORMAT_R11G11B10_FLOAT, 4 * BITS_PER_BYTE);
    FORMAT_PAIR(DXGI_FORMAT_R8G8B8A8_TYPELESS, DXGI_FORMAT_R8G8B8A8_SINT, 4 * 1 * BITS_PER_BYTE);
    FORMAT_PAIR(DXGI_FORMAT_R16G16_TYPELESS, DXGI_FORMAT_R16G16_SINT, 2 * 2 * BITS_PER_BYTE);
    FORMAT_PAIR(DXGI_FORMAT_R32_TYPELESS, DXGI_FORMAT_X24_TYPELESS_G8_UINT, 1 * 4 * BITS_PER_BYTE);
    FORMAT_PAIR(DXGI_FORMAT_R8G8_TYPELESS, DXGI_FORMAT_R8G8_SINT, 2 * 1 * BITS_PER_BYTE);
    FORMAT_PAIR(DXGI_FORMAT_R16_TYPELESS, DXGI_FORMAT_R16_SINT, 1 * 2 * BITS_PER_BYTE);
    FORMAT_PAIR(DXGI_FORMAT_R8_TYPELESS, DXGI_FORMAT_A8_UNORM, 1 * 1 * BITS_PER_BYTE);
    FORMAT_SINGLE(DXGI_FORMAT_R1_UNORM, 1);
    FORMAT_PAIR(DXGI_FORMAT_R9G9B9E5_SHAREDEXP, DXGI_FORMAT_G8R8_G8B8_UNORM, 4 * BITS_PER_BYTE);
    FORMAT_PAIR(DXGI_FORMAT_BC1_TYPELESS, DXGI_FORMAT_BC1_UNORM_SRGB, 4);
    FORMAT_PAIR(DXGI_FORMAT_BC2_TYPELESS, DXGI_FORMAT_BC3_UNORM_SRGB, 8);
    FORMAT_PAIR(DXGI_FORMAT_BC4_TYPELESS, DXGI_FORMAT_BC4_SNORM, 4);
    FORMAT_PAIR(DXGI_FORMAT_BC5_TYPELESS, DXGI_FORMAT_BC5_SNORM, 8);
    FORMAT_PAIR(DXGI_FORMAT_B5G6R5_UNORM, DXGI_FORMAT_B5G5R5A1_UNORM, 2 * BITS_PER_BYTE);
    FORMAT_PAIR(DXGI_FORMAT_B8G8R8A8_UNORM, DXGI_FORMAT_B8G8R8X8_UNORM_SRGB, 4 * BITS_PER_BYTE);
    FORMAT_PAIR(DXGI_FORMAT_BC6H_TYPELESS, DXGI_FORMAT_BC7_UNORM_SRGB, 8);
    FORMAT_SINGLE(DXGI_FORMAT_B4G4R4A4_UNORM, 2 * BITS_PER_BYTE);
#undef FORMAT_PAIR
#undef FORMAT_SINGLE
    return 0;
}
